 ...
 *
 * Descripción:
 * Información del firmware Receiver.
 ******************************************************************************/

#ifndef MK_RECEIVER_FIRMWARE_H
#define MK_RECEIVER_FIRMWARE_H
